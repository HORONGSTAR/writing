import { Container, Paper, IconButton, Stack, Snackbar } from '@mui/material'
...
function PostPage({ auth }) {
  ...
  return (
    <Container>
      ...
      <Snackbar open={open} autoHideDuration={3000} onClose={() => setOpen(false)} message="게시물 불러오기에 실패했습니다." />
    </Container>
  )
}
